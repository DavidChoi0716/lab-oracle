...
--하나의 테이블에서 두개 이상의 컬럼을 묶어서 PK지정
create table ex09 (
        col1 number primary key,
        col2 varchar2(20) primary key
);      
--테이블은 오직 한 개의 PK만 가질 수 있기 때문에 오류 발생 -- pair로 묶인 것이 primary key 역할을 한다.
create table ex09 (
         col1 number,
         col2 varchar2(20),
...
insert into ex09 values (2, 'a');  --불가능
insert into ex09 values (100, null);  --불가능
select*from ex09;
...
--column 이름만 보이게 하고 싶을 때 (test할 때)
